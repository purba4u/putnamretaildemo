...
//	WebUI.openBrowser("https://www.putnam.com/individual/")
    ...
    uik.navigateToPath('Account options', 'iframe_//iframe')
//	WebDriver driver  = uik.getCurrentSessionDriver()
//	driver.switchTo().frame(driver.findElement(By.xpath("//iframe")))
//	uik.navigateToPath('Account options')
	CustomKeywords.'customKeywords.PortalKeywords.waitForJsfPageLoad'(findTestObject('IndividualInvestor/PageSpecificObjects/Frames/dstDocTitle'), 'visible', 60)
//	sleep(20000)
    String actTitle = WebUI.getText(findTestObject('IndividualInvestor/PageSpecificObjects/Frames/dstDocTitle')).toLowerCase()

    if (actTitle.contains('account options')) {
        KeywordUtil.markPassed('Account Options page loaded successfully')
    } else {
	...
	sleep(10000)
	uik.navigateToPath('Get Forms', 'iframe_//iframe')
	sleep(10000)
