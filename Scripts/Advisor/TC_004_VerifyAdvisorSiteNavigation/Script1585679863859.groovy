...
WebUI.comment('Advisor Site Navigation test case started')

try {
    'Launching Advisor website'
    ...
    CustomKeywords.'customKeywords.PortalUIKeywords.verifyForBrokenLinks'(findTestObject('Advisor/NavigationContainer'), 
        'href', '')
	
	'Verifying hidden links under Fat nav and capturing the response code'
	//CustomKeywords.'customKeywords.PortalUIKeywords.verifyForBrokenLinks'(findTestObject('Advisor/HiddenNavContainer'),
		//'href', '')
