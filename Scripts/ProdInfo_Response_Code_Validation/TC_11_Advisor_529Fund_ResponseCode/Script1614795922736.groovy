        ...
        for (int sindex = 0; sindex <= (NoOfShareClass - 1); sindex++) {
			...
			if ((PrevUrl != url)&&(index != 1)) {
				...
				if (statusCode.equals('200')) {
					...
					CustomKeywords.'excelKeywords.WriteExcel.demoKey'(url,  'Server response is ' + statusCode, 'Passed', 'Advisor 529 funds', rowIndex, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A')
					PrevUrl = url
				} else {
					KeywordUtil.markFailed('Server response is ' + statusCode)
					CustomKeywords.'excelKeywords.WriteExcel.demoKey'(url,  'Server response is ' + statusCode, 'Failed', 'Advisor 529 funds', rowIndex, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A')
					WebUI.navigateToUrl(PrevUrl)
				}
				rowIndex = rowIndex + 1
			} else {
				KeywordUtil.markFailed('Same url as Previous URL, not able to select next fund')
				CustomKeywords.'excelKeywords.WriteExcel.demoKey'(url,  'Same url as Previous URL, not able to select next fund', 'Failed', 'Advisor 529 funds', rowIndex, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A')
			}
        }
    }
}
