...
try {
    //CustomKeywords.'customKeywords.PortalUIKeywords.loadUrl'((GlobalVariable.ENV + GlobalVariable.IndividualPath) + 'annuities/portfolios/343-george-putnam-balanced-fund-subaccount-paa-c')
    WebUI.navigateToUrl((GlobalVariable.ENV + GlobalVariable.IndividualPath) + 'annuities/portfolios/343-george-putnam-balanced-fund-subaccount-paa-c')
    ...
    for (int index = 1; index <= (NoOfFunds - 1); index++) {
        ...
        if (statusCode.equals('200')) {
			...
			CustomKeywords.'excelKeywords.WriteExcel.demoKey'(url,  'Server response is ' + statusCode, 'Passed', 'Ind Annuity All Adv pref funds', index, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A')
			PrevUrl = url
        } else {
