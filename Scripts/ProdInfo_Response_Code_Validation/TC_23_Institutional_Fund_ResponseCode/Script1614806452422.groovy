...
try {
    ...
    if (statusCode.equals('200')) {
        ...
        CustomKeywords.'excelKeywords.WriteExcel.demoKey'(url, 'Server response is ' + statusCode, 'Passed', 'Inst Fund', 
            1, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A')
    } else {
        KeywordUtil.markFailed('Server response is ' + statusCode)

        CustomKeywords.'excelKeywords.WriteExcel.demoKey'(url, 'Server response is ' + statusCode, 'Failed', 'Inst Fund', 
            1, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A')
    }
}
catch (Exception ex) {
