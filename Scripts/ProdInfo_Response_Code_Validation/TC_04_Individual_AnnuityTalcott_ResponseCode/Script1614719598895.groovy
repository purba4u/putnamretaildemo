...
try {
	WebUI.navigateToUrl((GlobalVariable.ENV + GlobalVariable.IndividualPath) + 'annuities/portfolios/129-george-putnam-balanced-fund-subaccount')
    ...
    for (int index = 1; index <= (NoOfFunds - 1); index++) {
        ...
        if (statusCode.equals('200')) {
			...
			CustomKeywords.'excelKeywords.WriteExcel.demoKey'(url,  'Server response is ' + statusCode, 'Passed', 'Ind Annuity Talcott funds', index, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A')
			PrevUrl = url
        } else {
